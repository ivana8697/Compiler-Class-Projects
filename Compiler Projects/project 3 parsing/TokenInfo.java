...
enum TokenKind {
    ...
    MINUS("-"), PLUS("+"), PLUS_ASSIGN("+="), STAR("*"), DIV ("/"), REM("%"), COMP("~"),
    OR("|"), XOR("^"), AND("&"), ALEFT_SHIFT("<<"), ARIGHT_SHIFT(">>"), LRIGHT_SHIFT(">>>"),
    QUESTION("?"), COLON(":"), NOT_EQ("!="), DIV_ASSIGN("/="), MINUS_ASSIGN("-="),
    STAR_ASSIGN("*="), REM_ASSIGN("%="), ARIGHT_SHIFT_ASSIGN(">>="), LRIGHT_SHIFT_ASSIGN(">>>="),
    GTEQ(">="), ALEFT_SHIFT_ASSIGN("<<="), LT("<"), XOR_ASSIGN("^="), OR_ASSIGN("|="), LOGIC_OR("||"),
    AND_ASSIGN("&="),
