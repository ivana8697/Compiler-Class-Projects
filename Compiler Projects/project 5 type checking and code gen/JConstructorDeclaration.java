...
class JConstructorDeclaration extends JMethodDeclaration implements JMember {
    ...
    public JAST analyze(Context context) {
        ...
        for (JFormalParameter param : params) {
            ...
            int offset = this.context.nextOffset();  //skip an offset for doubles and longs
    ...
    public void partialCodegen(Context context, CLEmitter partial) {
        partial.addMethod(mods, "<init>", descriptor, exceptionstrings, false);
    ...
    public void codegen(CLEmitter output) {
        output.addMethod(mods, "<init>", descriptor, exceptionstrings, false);
        if (!invokesConstructor) {
