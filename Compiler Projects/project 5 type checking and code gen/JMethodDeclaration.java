...
class JMethodDeclaration extends JAST implements JMember {
    ...
    protected ArrayList<TypeName> exceptions2;
    ...
    public void preAnalyze(Context context, CLEmitter partial) {
        ...
        //convert exceptions from TypeName to strings
        //if (exceptions != null) {
        //    exceptionstrings = new ArrayList<String>();
        //    for (int i = 0; i < exceptions.size(); i++){
        //        String name = (exceptions.get(i)).jvmName();
        //        exceptionstrings.add(name);
        //    }
       // }
    ...
    public JAST analyze(Context context) {
        ...
        for (JFormalParameter param : params) {
            ...
            int offset = this.context.nextOffset();  //we need an offset for doubles and longs
    ...
    public void partialCodegen(Context context, CLEmitter partial) {
        partial.addMethod(mods, name, descriptor, exceptionstrings, false);
    ...
    public void codegen(CLEmitter output) {
        output.addMethod(mods, name, descriptor, exceptionstrings, false);
        if (body != null) {
            body.codegen(output);
        }
        if (returnType == Type.VOID) {
