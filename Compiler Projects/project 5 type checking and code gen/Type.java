...
class Type {
     ...
     */
    public final static Type BOXED_DOUBLE = typeFor(java.lang.Character.class);

    /**
     * The java.lang.LONG type.
     */
    public final static Type BOXED_LONG = typeFor(java.lang.Character.class);
    ...
    private static String descriptorFor(Class<?> classRep) {
        return classRep == null ? "V" : classRep == void.class ? "V"
                ...
                : classRep == double.class ? "D"       //discriptor for doubles
                : classRep == long.class ? "J" : "?")  //discriptor for longs
