...
class JInterfaceDeclaration extends JAST implements JTypeDecl {
    ...
    private ArrayList<String> implemented;
    ...
    public void declareThisType(Context context) {
        ...
        if (superInterfaces != null) {
            ...
            for (int i = 0; i < superInterfaces.size(); i++){
                String name = (superInterfaces.get(i)).jvmName();
                implemented.add(name);
            }
        }
        partial.addClass(mods, qualifiedName, Type.OBJECT.jvmName(), implemented, false);
    ...
    public void preAnalyze(Context context) {
        ...
        //resolve the type for super interfaces
        //if (superInterfaces != null) {
          //  implemented = new ArrayList<String>();
            //for (int i = 0; i < superInterfaces.size(); i++){
              //  superInterfaces.set(i, (TypeName) superInterfaces.get(i).resolve(this.context));
            //}
        //}
        ...
        String qualifiedName = JAST.compilationUnit.packageName() == "" ?
                name : JAST.compilationUnit.packageName() + "/" + name;
        partial.addClass(mods, qualifiedName, superType.jvmName(), implemented, false);
    ...
    public void codegen(CLEmitter output) {
        ...
        String qualifiedName = JAST.compilationUnit.packageName() == "" ?
                name : JAST.compilationUnit.packageName() + "/" + name;
        output.addClass(mods, qualifiedName, superType.jvmName(), implemented, false);
