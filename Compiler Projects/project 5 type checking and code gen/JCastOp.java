...
class Conversions {
    ...
    public Conversions() {
        ...
        put(Type.INT, Type.DOUBLE, new I2D());   //int to double
        put(Type.INT, Type.LONG, new I2L());     //int to long
        put(Type.DOUBLE, Type.INT, new D2I());   //double to int
        //put(Type.DOUBLE, Type.CHAR, new D2C());  //double to char
        put(Type.DOUBLE, Type.LONG, new D2L());  //double to long
        //put(Type.CHAR, Type.DOUBLE, new C2D());  //char to double
        //put(Type.CHAR, Type.LONG, new C2L());    //char to long
        put(Type.LONG, Type.INT, new L2I());      //long to int
        put(Type.LONG, Type.DOUBLE, new L2D());      //long to double
        ...
        put(Type.DOUBLE, Type.BOXED_DOUBLE, new Boxing(Type.DOUBLE, Type.BOXED_DOUBLE)); //double
        put(Type.LONG, Type.BOXED_LONG, new Boxing(Type.LONG, Type.BOXED_LONG)); //long
        ...
        put(Type.BOXED_BOOLEAN, Type.BOOLEAN, new UnBoxing(Type.BOXED_BOOLEAN, Type.BOOLEAN,
                "booleanValue"));
        put(Type.BOXED_DOUBLE, Type.DOUBLE, new UnBoxing(Type.BOXED_DOUBLE, Type.DOUBLE, "doubleValue"));//double
        put(Type.BOXED_LONG, Type.LONG, new UnBoxing(Type.BOXED_LONG, Type.LONG, "longValue")); //long
    }
