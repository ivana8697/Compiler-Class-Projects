    ...
    public void codegen(CLEmitter output) {
        if (iDefn instanceof LocalVariableDefn) {
            ...
            if (type.isReference()) {
                ...
                if (type == Type.DOUBLE) {  //codegen for double
                    switch (offset) {
                        case 0:
                ...
                if (type == Type.LONG ) {  //codegen for long
                    switch (offset) {
                        case 0:
    ...
    public void codegenStore(CLEmitter output) {
        if (iDefn instanceof LocalVariableDefn) {
            ...
            if (type.isReference()) {
                ...
                if (type == Type.DOUBLE) {  //codegen store for double
                    switch (offset) {
                        case 0:
                ...
                if (type == Type.LONG) {  //codegen store for long
                    switch (offset) {
                        case 0:
